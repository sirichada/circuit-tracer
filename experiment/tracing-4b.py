...
try:
    ...
    with open("circuit_tracing_results_4b.json", "w") as f:
        json.dump(output_data_with_downstream, f, indent=2)
     
    print("\nCombined results successfully saved to circuit_tracing_results_4b.json")

except Exception as e:
    print(f"\nERROR: Failed to write JSON file: {e}")
    # Fallback: save what we have so we don't lose the whole script's progress
    with open("circuit_tracing_results_4b_fallback.json", "w") as f:
